<template>
  <div>
    ...
    <div class="home-row">
        ...
        <div class="panel-body">
          ...
          <div class="home-todo-list">
            <div class="home-todo-item">
              <p>{{ homepage.managerCount || 0 }}</p>
              <p>运营商</p>
              <p>
                <a @click="linkTo('smsOperatorManage')">查看</a>
              </p>
            </div>
            <div class="home-todo-item">
              <p>{{ homepage.provinceProxyCount || 0 }}</p>
              <p>省级代理商</p>
              <p>
                <a @click="linkTo('smsOperatorManage')">查看</a>
              </p>
            ...
            <div class="home-todo-item">
              ...
              <p>开通企业数</p>
              <p>
                <a @click="linkTo('smsFirmManage')">查看</a>
              </p>
            </div>
            <div class="home-todo-item">
            ...
            <div class="home-todo-item"
                 :class="{'c-red': homepage.messageRemain < 100}">
              <p :class="{'c-red': homepage.messageRemain < 100}">{{ homepage.messageRemain || 0 }}</p>
              <p>剩余可用短信数</p>
              <p>&nbsp;</p>
            </div>
            <div class="home-todo-item">
      ...
      <!-- <div class="home-sms-r">
        <div class="panel">
          <div class="panel-body home-sms-block">
            <div class="home-sms-row">
              <a class="home-sms-item" @click="linkTo()">开通省级代理</a>
              <a class="home-sms-item" @click="linkTo()">省级代理续费</a>
            </div>
            <div class="home-sms-row">
              <a class="home-sms-item" @click="linkTo()">开通市级代理</a>
              <a class="home-sms-item" @click="linkTo()">市级代理续费</a>
            </div>
          </div>
        </div>
      </div> -->
...
const API_STCS = API.sms.statistics
// 1 七天  2 三十天 3 年
const RadioArr = [
  { label: '7天', value: 1 },
  { label: '30天', value: 2 },
