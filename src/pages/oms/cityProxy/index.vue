<template>
    <div>
                    ...
                    <div class="panel">
                        <div class="panel-header">
                            ...
                            <div class="panel-header-tools"
                                ...
                                <Button type="error"
                                        @click="deleteCityProxy">删除</Button>
                            </div>
                        </div>
                        <div class="panel-body"
                             v-show="!itemList.length">
        ...
        <buy-port v-model="buyModalVisible"
                  :entry="currentProxy"
                  @after-save="afterSaveBuyPort"></buy-port>
...
export default {
    ...
    methods: {
        ...
        async getItemList() {
            let vm = this
            let result = await this.$omsApi.cityProxy.getCityProxyList(vm.assignItemQuery(vm.query))
