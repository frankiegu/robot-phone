                ...
                <div class="panel">
                    <div class="panel-body">
                        <Form class="panel-form"
                            ...
                            <!-- <FormItem label="">
                                <i-select clearable v-model="query.provinceId" style="width: 180px;" placeholder="选择省份">
                            ...
                            <!-- <FormItem label="" :label-width="20">
                                <i-select clearable v-model="query.cityProxyType" style="width: 180px;" placeholder="选择代理类型">
                        ...
                        <div class="panel-header">
                            ...
                            <div class="panel-header-tools">
                                <i-button type="primary"
                                          icon="plus"
                                          @click="handlerAddProxy">开通省代</i-button>
                            </div>
                        </div>
                        <div class="panel-body"
                                    ...
                                    <div class="list-item">
                                        ...
                                        <div class="list-item-main">
                                            ...
                                            <div class="list-item-info">
                                                <ins :class="['medal',item.provinceName?'medal-gold':'medal-sliver']">{{item.provinceName||'无省份'}}</ins>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                    ...
                    <div class="panel">
                        <div class="panel-header">
                            ...
                            <div class="panel-header-tools"
                                ...
                                <Button type="error"
                                        @click="deleteProvinceProxy">删除</Button>
                            </div>
                        </div>
                        <div class="panel-body"
                             v-show="!itemList.length">
        ...
        deleteProvinceProxy() {
            this.$Modal.confirm({
                ...
                onOk: (action, instance) => {
                    this.$omsApi.provinceProxy.deleteProxy(this.currentProxy.id).then(() => {
                        this.pageInit()
                        this.success("删除成功");
                    })
                }
