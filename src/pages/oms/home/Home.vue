<template>
  <div>
    ...
    <div class="home-row">
      <div class="home-sms-l">
        <div class="panel">
          <div class="panel-body">
            <p class="home-header">待处理数据</p>
            <div class="home-todo-list">
              <div class="home-todo-item">
                <p>{{ homepage.noticeCount || 0 }}</p>
                <p>发布消息数</p>
                <p><a @click="linkTo('OMS-NOTICE_INFO')">查看</a></p>
              </div>
              <div class="home-todo-item">
              ...
              <div class="home-todo-item">
                ...
                <p>市级代理商</p>
                <p><a @click="linkTo('omsCityProxyBaseInfo')">查看</a></p>
              </div>
              <div class="home-todo-item">
        ...
        <div class="panel">
          <div class="panel-body home-sms-block">
            <div class="home-sms-row">
              <a class="home-sms-item"
                 @click="linkTo()">开通省级代理</a>
              <a class="home-sms-item"
                 @click="linkTo()">省级代理续费</a>
            </div>
            <div class="home-sms-row">
              <a class="home-sms-item"
                 @click="linkTo('omsCityProxyBaseInfo')">开通市级代理</a>
              <a class="home-sms-item"
                 @click="linkTo('omsCityProxyBaseInfo')">市级代理续费</a>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="home-body">
              <div class="home-call-l">
                <div class="home-call-block">
                  <div class="left"><span class="circle circle-purple"></span></div>
                  <div class="right">
                ...
                <div class="home-call-block">
                  <div class="left"><span class="circle circle-blue"></span></div>
                  <div class="right">
